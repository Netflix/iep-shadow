...
object SerialSubscription {
  ...
  /**
   * Creates a [[iep.rx.lang.scala.subscriptions.SerialSubscription]].
   */
  def apply(): SerialSubscription =  new SerialSubscription(new iep.rx.subscriptions.SerialSubscription())

  /**
   * Creates a [[iep.rx.lang.scala.subscriptions.SerialSubscription]] that invokes the specified action when unsubscribed.
   */
 ...
 */
class SerialSubscription private[scala] (override val asJavaSubscription: iep.rx.subscriptions.SerialSubscription) extends Subscription {
