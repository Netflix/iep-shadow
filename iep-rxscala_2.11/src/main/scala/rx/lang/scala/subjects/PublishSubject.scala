...
object PublishSubject {
   ...
   */
  def apply[T](): PublishSubject[T] =  new PublishSubject[T](iep.rx.subjects.PublishSubject.create[T]())
}

private [scala] class PublishSubject[T] private [scala] (val asJavaSubject: iep.rx.subjects.PublishSubject[T]) extends Subject[T]  {}
