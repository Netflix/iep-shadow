...
object BehaviorSubject {
  ...
  def apply[T](): BehaviorSubject[T] = {
    new BehaviorSubject[T](iep.rx.subjects.BehaviorSubject.create())
  }
  ...
  def apply[T](defaultValue: T): BehaviorSubject[T] = {
    new BehaviorSubject[T](iep.rx.subjects.BehaviorSubject.create(defaultValue))
  }
}

class BehaviorSubject[T] private[scala] (val asJavaSubject: iep.rx.subjects.BehaviorSubject[T]) extends Subject[T]  {}
