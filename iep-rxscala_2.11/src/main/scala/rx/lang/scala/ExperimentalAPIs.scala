 ...
 *
 * `import iep.rx.lang.scala.ExperimentalAPIs._` to enable them.
 */
class ExperimentalObservable[+T](private val o: Observable[T]) {
  ...
  def switchIfEmpty[U >: T](alternate: Observable[U]): Observable[U] = {
    val jo = o.asJavaObservable.asInstanceOf[iep.rx.Observable[U]]
  ...
  def flatMapWithMaxConcurrent[R](f: T => Observable[R], maxConcurrent: Int): Observable[R] = {
    toScalaObservable[R](o.asJavaObservable.flatMap[R](new Func1[T, iep.rx.Observable[_ <: R]] {
