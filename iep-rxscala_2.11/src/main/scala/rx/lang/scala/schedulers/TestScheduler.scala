 ...
 *   val observer = mock(classOf[iep.rx.Observer[Long]])
 *
 ...
 * }}}
 */
class TestScheduler private[scala] (val asJavaScheduler: iep.rx.schedulers.TestScheduler) extends Scheduler {
