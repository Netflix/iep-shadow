 ...
 * 
 * In Scala, this package only contains [[iep.rx.lang.scala.observables.BlockingObservable]].
 * In the corresponding Java package `iep.rx.observables`, there is also a
